...
public class A_BTApp extends Service implements MonitorNotifier {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        BeaconManager beaconManager = org.altbeacon.beacon.BeaconManager.getInstanceForApplication(A_BTApp.this);
        ...
        Intent intent1 = new Intent(this, A_Monitoring.class);
    ...
    private void sendNotification() {
        ...
        startService(new Intent(this, A_Monitoring.class));
        stackBuilder.addNextIntent(new Intent(this, A_Monitoring.class));
