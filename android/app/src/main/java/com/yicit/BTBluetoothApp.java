        ...
        new Thread(
                new Runnable() {
                    ...
                    public void run() {
                            ...
                            BeaconManager beaconManager = org.altbeacon.beacon.BeaconManager.getInstanceForApplication(BTBluetoothApp.this);
                            ...
                            Notification.Builder builder = new Notification.Builder(BTBluetoothApp.this);
                            //builder.setSmallIcon(R.drawable.ic_launcher);
                            builder.setContentTitle("Scanning");
                            Intent intent = new Intent(BTBluetoothApp.this, MonitoringActivity.class);
                            PendingIntent pendingIntent = PendingIntent.getActivity(
                                    BTBluetoothApp.this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT
                            );
                            //BT-Anlamadım
