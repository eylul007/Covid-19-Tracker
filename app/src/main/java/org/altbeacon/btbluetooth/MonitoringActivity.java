package org.altbeacon.btbluetooth;
...
public class MonitoringActivity extends Activity implements MonitorNotifier {
	...
	/*public void onEnableClicked(View view) {
		...
		if (BeaconManager.getInstanceForApplication(this).getMonitoredRegions().size() > 0) {
			BeaconManager.getInstanceForApplication(this).stopMonitoring(BTBluetoothApp.wildcardRegion);
			button.setText("Enable Monitoring");
		}
		else {
			BeaconManager.getInstanceForApplication(this).startMonitoring(BTBluetoothApp.wildcardRegion);
